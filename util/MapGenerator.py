...
"""
    ...
    galaxyDensityMap = Image.open("B:\\branchDev\\assets\\maps\\galaxyDensityMap.png")
    ...
    if system is None:
        ...
        try: colorizer = Image.open(f"B:\\branchDev\\assets\\maps\\planets\\{planetType}world.png")
        except Exception: colorizer = Image.open("B:\\branchDev\\assets\\maps\\planets\\Cworld.png")
